...
import { WorkerEvent } from '../schema/WorkerEvent';
...
export default function ChatWindow(props: {
  ...
  const [messages, setMessages] = createSignal<ChatWindowMessage[]>([]);
  ...
  function handleSubmit() {
    setIsLoading(() => false);
    worker.postMessage({ question: input(), sessionId });
    setInput('');
  }

  return (
    <>
      <div class="flex flex-col-reverse w-full mb-4 overflow-auto grow">
